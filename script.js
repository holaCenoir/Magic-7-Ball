...
let games = "chase";
let Aaron = "nerd";
  magic8Ball.listOfAnswers = [cheese, drinks, games, Aaron];
  ...
  /* 
    ...
    2c. Whoaaaa... why did that happen?
        Answer: The higher the nomber, the slower the fade gets. 
  ...
  */
    ...
    /*
      ...
      3b. What happened?
          Answer: It only puts the first answer in the array, it only does the first because the array starts with 0



      3c. Try putting 1. What happened then?
          Answer: It only puts the second answer in the array, it only does the second because the array starts with 0
    ...
    */
    ...
    var answer = this.listOfAnswers[400];
    ...
    /*
      ...
      4a. Where the heck are we going to see the question and answer printed from the two
          console.log() below??
          Answer: We can see it whe we inspect the console
  ...
  */
  ...
  var onClick = function() {
    ...
    */
    $("#8ball").attr("src", "https://giphy.com/gifs/friday-link-black-cinema-BNaWQC4eso4YE")
